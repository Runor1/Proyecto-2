    ...
    <div id="carouselExample" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="/img/crossfit.png" class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="/img/pilates.png" class="d-block w-100">
            </div>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 mb-3">
                <div class="card card-custom">
                    <img src="/img/spinning.png" class="img-fluid">
                </div>
            </div>

            <div class="col-md-4 mb-3">
                <div class="card card-custom">
                    <img src="/img/zumba.png" class="img-fluid">
                </div>
            </div>

            <div class="col-md-4 mb-3">
                <div class="card card-custom">
                    <img src="/img/funcional.png" class="img-fluid">
                </div>
            </div>
